...
用法:
  SSHPASS='3dvision' python3 sync_videos_rsync.py --loop --interval 300
  SSHPASS='3dvision' python3 sync_videos_rsync.py --dry-run --max-files 20
"""
import argparse
import os
import shlex
...
def main():
    ...
    if not env.get("SSHPASS"):
        raise SystemExit("请设置 SSHPASS 环境变量，例如: SSHPASS='3dvision' python3 sync_videos_rsync.py")
